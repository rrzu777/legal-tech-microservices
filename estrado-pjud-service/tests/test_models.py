...
class TestSearchRequestCorte:
    def test_corte_valid_for_apelaciones(self):
        req = SearchRequest(case_type="rol", case_number="Proteccion-4490-2025", competencia="apelaciones", corte=16)
        assert req.corte == 16
    ...
    def test_corte_valid_san_miguel(self):
        req = SearchRequest(case_type="rol", case_number="Proteccion-4490-2025", competencia="apelaciones", corte=17)
        assert req.corte == 17
    ...
    def test_corte_rejected_for_civil(self):
        with pytest.raises(ValidationError, match="corte"):
            SearchRequest(case_type="rol", case_number="C-1234-2024", competencia="civil", corte=16)

    def test_corte_rejected_for_penal(self):
        with pytest.raises(ValidationError, match="corte"):
            SearchRequest(case_type="rit", case_number="O-500-2024", competencia="penal", corte=16)
